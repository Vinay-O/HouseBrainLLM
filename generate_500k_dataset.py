#!/usr/bin/env python3
"""
HouseBrain 500K Enhanced Dataset Generator

Generates 500K synthetic architectural datasets for training the HouseBrain LLM.
Enhanced with crucial parameters: plot shape, exterior finishes, climate, building codes.
Optimized for maximum quality and free tier usage.
"""
...
@dataclass
class DatasetConfig:
    """Configuration for 500K dataset generation"""
    num_samples: int = 500000
    output_dir: str = "housebrain_dataset_v5_500k"
